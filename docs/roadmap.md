...
| 2 — memory graph | Typed recursive walker, allocation ledger, identity, aliases, cycles, references | Two aliases to one node, cyclic list, stack pointers, dangling pointer, freed/reused address |
